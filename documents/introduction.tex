...
The number of oscillations per turn has to be chosen to avoid resonances. Every harmonic of the tune can amplify dipoles or quadrupoles errors and lead to particules leaving the ring. The tune has to be modified using dipoles and quadrupoles that are placed around the machine to be at a working point.
...
The particules in the machine have a certain spread so the tune working point is a small area.
