...
to support template correctly. The final version that will run on a newer version of the Linux operating system should be able to handle templates, which will make the switch front single to double precision easier.
